...
import 'package:mad_project/screens/feedback_screen.dart';
import 'dart:io';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void _removeAllPages() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text("✅ All saved pages removed")),
    );
  }
